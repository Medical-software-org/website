  ...
  return (
    ...
    >
      ...
      <p>
        ...
        We reserve the right to amend this Privacy Notice from time to time. If
      ...
      <ul>
        ...
        <li>
          ...
          e.g., information provided <br /> by a hospital so that a user of our
          software may access and use the software.
        </li>
      </ul>
      ...
      <p>
        All personal data you provide to us is stored on our secure servers and
        in secure filing systems.
        <br />
        We have in place policies, procedures and technologies to maintain the
        security of all personal data from the point of collection to the point
        of destruction including procedures to deal with a security breach.
        <br />
        We will ensure your personal data is only accessible by those who need
        to see it for their specific role.
        <br />
        We will only transfer your personal data to a third party if that third
        party agrees to comply with our procedures and policies or if they have
        put in place equivalent policies and procedures of their own.
        <br />
      </p>
      ...
      <table>
        ...
        <tr>
          <td>Website visitor/user</td>
          <td>
            To assist or improve the individual's use of the website or software
          </td>
        ...
        <tr>
          ...
          <td>
            To provide our software for use by the licensee/user; to administer
            and enforce the terms of our software licence
          </td>
          <td>
            Contract
        ...
        <tr>
          ...
          <td>
            Providing details of our services / products; assisting with support
            issues relating to our software
          </td>
          <td>Legitimate Interests</td>
        </tr>
      </table>
      <p>
        ...
        able to fulfil our contractual obligation(s) to you and this may have a
        ...
        example, if you would like to understand what our "legitimate interests"
        are for any specific processing activity) please contact us.
      </p>
      <h4>How long will we keep your personal data?</h4>
      <p>
        We will not keep your personal data for longer than is necessary for the
        purpose(s) for which we process it.
        <br />
      ...
      <ul>
        ...
        <li>
          request for any inaccurate personal data which we hold about you to be
          rectified.
        </li>
      ...
      <p>
        ...
        the request in writing. Please note some of these rights are restricted
      ...
      <p>
        ...
        <br />
        All our personnel have received data protection training and understand
        the need to keep your personal data confidential and to use it only for
        legitimate purposes.
        <br />
      ...
      <ul>
        <li>
          ...
          disclose your <br /> personal data to the prospective seller or buyer
      ...
      <p>
        If your personal data is provided to any third parties, you are entitled
        to request details of the recipients of your personal data or the
